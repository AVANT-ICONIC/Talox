...
const PATTERNS: readonly ErrorPattern[] = [
	// ── Selector issues ─────────────────────────────────────────────────
	{
		...
		friendly: "Element matched multiple results. Use a more specific selector (try text content, role, or nth-child).",
		category: "selector",
	...
	// ── Navigation timeout (must come before generic timeout) ─────────
	{
		...
		friendly: "Page took too long to load. Try increasing the timeout or check if the page requires authentication.",
		category: "navigation",
	...
	},
	{
		...
		friendly: "Element exists but isn't visible. Wait for it to become visible or scroll it into view first.",
	...
	// ── Navigation / context issues ─────────────────────────────────────
	{
		...
		friendly: "Page navigated away while executing. Re-get the element after navigation and retry.",
		category: "navigation",
	...
	},
	{
		...
		friendly: "The browser context or page has been disposed. Create a new session.",
		category: "browser",
		suggestion: "Call launch() to create a new browser session before continuing.",
	},
	// ── Interaction ─────────────────────────────────────────────────────
	{
		...
		friendly: "Element was intercepted by another element. Try scrolling or using a different interaction method.",
		category: "interaction",

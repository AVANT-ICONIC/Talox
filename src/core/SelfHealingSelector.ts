...
export class SelfHealingSelector {
	...
	async heal(failedSelector: string, currentNodes: TaloxNode[]): Promise<FallbackResult | null> {
	...
	private extractContext(_node: TaloxNode, parentNode?: TaloxNode): SuccessState["context"] {
		return {
